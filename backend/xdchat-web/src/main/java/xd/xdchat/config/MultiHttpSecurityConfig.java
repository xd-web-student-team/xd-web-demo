...
import xd.xdchat.service.impl.AdminServiceImpl;
import xd.xdchat.service.impl.UserServiceImpl;
...
public class MultiHttpSecurityConfig {
    ...
    public static class AdminSecurityConfig extends WebSecurityConfigurerAdapter{
        ...
        //忽略"/login"请求，该请求不需要进入Security的拦截器
        @Override
...
//    }
        ...
        @Override
        public void configure(WebSecurity web) throws Exception {
            web.ignoring().antMatchers("/login","/verifyCode","/user/upload_profile","/file","/user/register","/user/checkUsername","/user/checkNickname");
        }
        //登录验证
        @Override
        protected void configure(HttpSecurity http) throws Exception {
